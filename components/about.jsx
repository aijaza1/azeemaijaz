        ...
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <Image
                    ...
                    height='500'
                    width='500'
                    className="w-4/6 h-4/6 md:w-full md:h-auto m-auto shadow-xl shadow-gray-400 rounded-full flex items-center justify-center p-3 hover:scale-105 ease-in duration-300"
                />
